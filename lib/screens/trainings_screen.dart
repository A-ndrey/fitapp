  ...
  Future<void> _openExercisePicker() async {
    final exercise = await showModalBottomSheet<Exercise>(
      ...
      builder: (sheetContext) =>
          _TrainingExercisePickerSheet(exercises: widget.store.exercises),
    );
...
class _TrainingExercisePickerSheet extends StatefulWidget {
  const _TrainingExercisePickerSheet({required this.exercises});

  final List<Exercise> exercises;

  @override
  State<_TrainingExercisePickerSheet> createState() =>
      _TrainingExercisePickerSheetState();
}

class _TrainingExercisePickerSheetState
    extends State<_TrainingExercisePickerSheet> {
